	      ...
	      <div class="modal-body">
	        	<form class="form-horizontal" id="form4">
	        	  ...
	        	  <div class="form-group" >
                        <label class="control-label col-xs-3">enrollId</label>
                        <div class="col-xs-9">
                        	<input class="form-control" id="userLockId" name="enrollId">
                        </div>
                    </div> 
                      <div class="form-group">
                        <label class="control-label col-xs-3">weekZone</label>
                        <div class="col-xs-9">
                        	<select class="form-control" id="weekZone" name="weekZone">
...
<div class="modal fade" id="addUserModal" tabindex="-1" role="dialog"
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12">
				<h1>LexusTech Facial Recognition Terminal</h1>
			</div>
		</div>
		<!-- 按钮 -->
		<div class="row">
	...
	//	var empId = $(this).parents("tr").find("td:eq(2)").text();
	   ...
	   //保存天时段
		...
		$("#userLock_btu").click(function(){
			...
			//1.判断之前的用户名校验是否成功，否则就不往下走
			var enrollId=document.getElementById('userLockId').value;
			var weekZone=document.getElementById('weekZone').value;
			...
			$.ajax({
				...
				type:"POST",
				data:{enrollId: enrollId,weekZone: weekZone,group: group,deviceSn: deviceSn},
				success:function(result){
